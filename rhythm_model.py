...
def build_rhythm_model(weights_path=None):
    ...
    melody_left = LSTM(units=RNN_SIZE, 
                    name='melody_left')(input_melody_left)
    ...
    melody_right = LSTM(units=RNN_SIZE, 
                     name='melody_right')(input_melody_right)
    beat_left = LSTM(units=RNN_SIZE, 
                    name='beat_left')(input_beat_left)
    ...
    beat_right = LSTM(units=RNN_SIZE, 
                     name='beat_right')(input_beat_right)
    rhythm_left = LSTM(units=RNN_SIZE, 
                         name='rhythm_left')(input_rhythm_left)
...
def train_model(data, data_val, weights_path='rhythm_'+WEIGHTS_PATH):
